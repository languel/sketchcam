...
- **UI**: dockable/floating controls for Settings, Layers, Camera, Movie, Marks, Input Map, Yarn, Wrap, Line walk, Ink, Paper, Web, Presets, Keys, Output, History, Timeline, and Debug, with compact one-line style rows.
