...
final class MetalLineRenderer {
    ...
    @discardableResult
    func render(strokes: [StrokeTessellator.Stroke], ribbon: Bool = true, roundCaps: Bool = false, into pixelBuffer: CVPixelBuffer) -> Bool {
        ...
        let verts = StrokeTessellator.tessellate(strokes, ribbon: ribbon, roundCaps: roundCaps)
