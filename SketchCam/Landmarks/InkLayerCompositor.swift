...
final class InkLayerCompositor {
    ...
    func layer(settings: ProcessingSettings, outputSize: CGSize, frameIndex: Int) -> CIImage? {
        ...
        return lock.withLock {
            ...
            return engine?.layer(settings: settings, outputSize: outputSize, frameIndex: frameIndex)
        }
    }
}
